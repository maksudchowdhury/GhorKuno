...
class TestModels(TestCase):
    ...
    def test_ItemReview(self):
        ...
        self.assertEquals(self.ItemReview.phNo, 'good')
    ...
    def test_Cart(self):
        ...
        self.assertEquals(self.Cart.rating, 1)
...
class UrlsTest(APITestCase):
    ...
    def test_shop (self) :
        data = {'shopName': 'none'}
        client=APIClient()
        client.credentials(HTTP_AUTHORIZATION='JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjQ5MDI3MTgyLCJqdGkiOiI4ZjgwYzBmZDU3ODc0MjUzOGExNzE2OWM5ZGY5ZTdjYSIsInVzZXJfaWQiOjF9.eDp6ciYnztRGe3nnCnTTMeDsHsTs0ZEqjW2_N901QRw')
